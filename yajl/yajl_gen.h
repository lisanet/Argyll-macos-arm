...
extern "C" {
	...
	YAJL_API yajl_gen_status yajl_gen_c_comment(yajl_gen g, const unsigned char * str,
                                                unsigned int len, int dlytoeol);
	YAJL_API yajl_gen_status yajl_gen_cpp_comment(yajl_gen g, const unsigned char * str,
	                                              unsigned int len);
